    ...
    return (
        <div>
            ...
            <div className='flex flex-wrap justify-center gap-4 md:gap-4 sm:gap-4'>
                <a
                    className='flex flex-col bg-gray-900 rounded-lg text-green-400 hover:bg-green-400 transition-color hover:text-white transition-color'
                    style={{ width: '280px', height: '285px' }}
                    href='https://github.com/FOSS-Community/website-fossc'
                >
                    <img src={STEP_1} alt='Step 1 Icon' className='w-40 mx-auto mt-4 mb-3' />
                ...
                <div
                    ...
                    style={{ width: '280px', height: '285px' }}
                >
                    <img src={STEP_2} alt='Step 2 Icon' className='w-25 mx-auto' />
                ...
                <div
                    ...
                    style={{ width: '280px', height: '285px' }}
                >
                    <img src={STEP_3} alt='Step 3 Icon' className='w-30 mx-auto' />
                ...
                <a
                    className='flex flex-col bg-gray-900 rounded-lg text-green-400 hover:bg-green-400 transition-color hover:text-white transition-color'
                    style={{ width: '280px', height: '285px' }}
                    href='https://discord.com/channels/983838934624780288/986650931754053644'
                >
                    <img src={STEP_4} alt='Step 4 Icon' className='w-40 mx-auto mt-10 mb-8' />
