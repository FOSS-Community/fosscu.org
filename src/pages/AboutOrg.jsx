...
const AboutOrg = () => {
  return (
    <div>
      <Navbar />
      <div class="text-[#ffffff] body-font bg-black">
        <div class="container px-5 py-24 mx-auto">
          ...
          <div class="flex flex-wrap">
            <div class="xl:w-1/4 lg:w-1/2 md:w-full px-8 py-6 border-l-2 border-gray-800">
              <h2 class="text-lg sm:text-xl text-[#00b300] font-medium title-font mb-2">Open to all</h2>
            ...
            <div class="xl:w-1/4 lg:w-1/2 md:w-full px-8 py-6 border-l-2 border-gray-800">
              <h2 class="text-lg sm:text-xl text-[#00b300] font-medium title-font mb-2">Mentorship to beginners</h2>
            ...
            <div class="xl:w-1/4 lg:w-1/2 md:w-full px-8 py-6 border-l-2 border-gray-800">
              <h2 class="text-lg sm:text-xl text-[#00b300] font-medium title-font mb-2">Regular Meetups</h2>
            ...
            <div class="xl:w-1/4 lg:w-1/2 md:w-full px-8 py-6 border-l-2 border-gray-800">
              <h2 class="text-lg sm:text-xl text-[#00b300] font-medium title-font mb-2">Events and Bootcamps</h2>
          ...
          <a href="https://linktr.ee/fosscu" target="_blank" rel="noopener noreferrer">
            <button
              class="flex mx-auto mt-16 text-black bg-[#CCFFCC] font-poppins border-0 py-2 px-8 focus:outline-none rounded text-lg hover:shadow-md hover:shadow-white">Connect with Us 🤝
            </button>
          </a>
        </div>
      </div>
