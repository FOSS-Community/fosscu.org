...
const Vue_js: React.FC<VueJsProps> = (props) => {
  const [check, setCheck] = useState<boolean>(false);

  return (
    <div>
      <section className="">
        <p className="">Vue.js Learning Resources</p>
          ...
          <div className="max-w-screen-xl sm:text-lg text-gray-100">
            ...
            {props.videoLink && (
              <button
                ...
                className="bg-[green] hover:bg-[#00df9a] duration-200 text-white font-bold py-2 px-4 rounded"
              >
