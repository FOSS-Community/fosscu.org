...
const PrivacyPolicy: React.FC  = () => {
  return (
    <div className="sm:container  text-gray-300 sm:mx-auto p-5 m-4">
      ...
      <br></br>
      <h1 className="text-3xl text-white">Interpretation and Definitions</h1>
      <br></br>
      <h2 className="text-2xl text-white">Interpretation</h2>
      <br></br>
      <p>
      ...
      <br></br>
      <h2 className="text-2xl text-white">Definitions</h2>
      <br></br>
      ...
      <ul className="list-disc p-5">
        ...
        <li>
          <p>
            ...
            this Agreement) refers to FOSSCU, KIET Group of Institutions,
            Delhi-NCR, Ghaziabad.
          </p>
        </li>
        <li>
      ...
      <br></br>
      <h2 className="text-2xl text-white">Types of Data Collected</h2>
      <br></br>
      <h3 className="text-2xl text-white">Personal Data</h3>
      <br></br>
      <p>
      ...
      <h3 className="text-2xl text-white">Usage Data</h3>
      <br></br>
      ...
      <br></br>
      <h3 className="text-2xl text-white">Tracking Technologies and Cookies</h3>
      <br></br>
      <p>
      ...
      <br></br>
      <h2 className="text-2xl text-white">Use of Your Personal Data</h2>
      <br></br>
      ...
      <h2 className="text-2xl text-white">Retention of Your Personal Data</h2>
      <br></br>
      <p>
      ...
      <br></br>
      <h2 className="text-2xl text-white">Transfer of Your Personal Data</h2>
      <br></br>
      <p>
      ...
      <br></br>
      <h2 className="text-2xl text-white">Delete Your Personal Data</h2>
      <br></br>
      <p>
      ...
      <br></br>
      <h2 className="text-2xl text-white">Disclosure of Your Personal Data</h2>
      <br></br>
      <h3 className="text-xl text-white">Business Transactions</h3>
      <br></br>
      <p>
      ...
      <br></br>
      <h3 className="text-xl text-white">Law enforcement</h3>
      <br></br>
      <p>
      ...
      <br></br>
      <h3 className="text-xl text-white">Other legal requirements</h3>
      <br></br>
      <p>
      ...
      <h2 className="text-2xl text-white">Security of Your Personal Data</h2>
      <br></br>
      <p>
      ...
      <br></br>
      <h1 className="text-3xl text-white">Children&apos;s Privacy</h1>
      <br></br>
      <p>
      ...
      <br></br>
      <h1 className="text-3xl text-white">Links to Other Websites</h1>
      <br></br>
      <p>
      ...
      <br></br>
      <h1 className="text-3xl text-white">Changes to this Privacy Policy</h1>
      <br></br>
      <p>
