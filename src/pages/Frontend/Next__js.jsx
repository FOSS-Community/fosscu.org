...
const Next__js = () => {
    ...
    return (
        <div>
            ...
            <p className=" text-5xl mx-auto max-w-screen-xl lg:py-8 lg:px-6 mt-10 font-bold font-sans tracking-tight text-white">Next.js Resources:</p>
            <div class="border-b border-gray-300 my-2 mx-auto max-w-screen-xl mb-12 lg:px-6"></div>
            {nextjsData.map((nextjs) => (
                <Next_js
                    head={nextjs.head}
                    para1={nextjs.para1}
                    para2={nextjs.para2}
